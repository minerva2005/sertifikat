...
<form action="process_input_certificate_assignments.php" method="POST">
    <h2 style="text-align: center;">Input Data Event</h2>

    

    <label for="full_name">oilih:</label><br>
        <select name="full_name" id="full_name">
            ...
            $sql = "SELECT user_id, full_name FROM users "; // Ganti dengan nama tabel dan kolom Anda
    ...
    <label for="participant_name">pilih event:</label><br>
        <select name="participant_name" id="participant_name">
            ...
            // Query untuk mengambil data program
            $sql = "SELECT certificate_id, participant_name FROM certificate "; // Ganti dengan nama tabel dan kolom Anda
